...
if (document.images) {
  var blank = new Image()
  blank.src = "Acordes_y_Escalas/images/vpcblank.gif"

  var select = new Image()
  select.src = "Acordes_y_Escalas/images/vpcselect.gif"

  var scalfil = new Image()
  scalfil.src = "Acordes_y_Escalas/images/vpcscalfil.gif"

  var black = new Image()
  black.src = "Acordes_y_Escalas/images/vpcblack.gif"
